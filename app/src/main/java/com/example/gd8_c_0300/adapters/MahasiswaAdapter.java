package com.example.gd8_c_0300.adapters;
...
import com.example.gd8_c_0300.AddEditActivity;
import com.example.gd8_c_0300.MainActivity;
import com.example.gd8_c_0300.R;
import com.example.gd8_c_0300.models.Mahasiswa;
                        ...
                        .setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (context instanceof MainActivity)
                                    ((MainActivity) context).deleteMahasiswa(mahasiswa.getId());
                            }
                        })
                        .show();
            }
